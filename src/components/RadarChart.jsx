export default function RadarChart({ series, labels }) {
  ...
  return (
    <div className="sz-radar-wrap">
      <svg viewBox="-200 -160 400 320" className="sz-radar">
        <g className="sz-radar-grid" fill="none" stroke="#e6eef6" strokeWidth="0.8">
